...
# I'm trying to understand still why any of the steps mean. 
# In a way this helps the programming for on-going processes, but I don't see how it helps with the Wolfram rules.
# Anyway, I'll first finish the assignment, then scatter it into segments, and feed it to CHATGPT to see if it can help me understand.